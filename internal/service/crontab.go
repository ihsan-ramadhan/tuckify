...
func buildCrontabLine(name, binaryPath, folder, cronExpr, configPath string) string {
...
func upsertCrontabContent(curr, name, binaryPath, folder, cronExpr, configPath string) string {
	tag := managedTag(name)
	var kept []string
	...
	kept = append(kept, buildCrontabLine(name, binaryPath, folder, cronExpr, configPath))
...
func (c *CrontabService) Install(name, folder, cronExpr, configPath string) error {
	...
	content := upsertCrontabContent(curr, name, binaryPath, folder, cronExpr, configPath)
